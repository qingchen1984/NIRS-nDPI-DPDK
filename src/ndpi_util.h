...
typedef struct ndpi_flow_struct ndpi_flow_struct_t;
typedef struct ndpi_detection_module_struct ndpi_detection_module_struct_t;
...
typedef struct ndpi_stats {
  ...
  u_int64_t total_wire_bytes;
  u_int64_t total_ip_bytes;
  u_int64_t total_discarded_bytes;
  ...
  u_int64_t vlan_count;
  u_int64_t fragmented_count;
